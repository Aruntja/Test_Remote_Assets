...
exports.scriptName = exports.chunksCacheBy2D = exports.replaceScriptList = exports.scriptList = exports.uuidList = exports.importSubAssets = exports.importProjectAssets = exports.replaceFbxUuidMap = exports.layerToGroupMap = exports.collator = exports.SKIPS_SCRIPT = void 0;
    ...
    function step(dir) {
        ...
        names.forEach((name) => {
            ...
            if (regexp.test(name)) {
                ...
                chunksMap.set(name, {
                    from: file, // 源文件
                    to: (0, path_1.join)(Editor.Project.path, 'assets', 'migrate-resources', 'chunks', name + '.chunk'), // 导入到项目到
                    content: content,
